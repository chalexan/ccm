...
const VideoServe = () => {
  const data = [
    ...
    },
    {
      title: "Пусконаладка",
      description:
        "Настройка оборудования: настройка зоны обзора камер, удаленного доступа, проверка работоспособности ситемы в разных режимах работы",
  ...
  return (
    <div>
      ...
      <p>
        {" "}
        Выполняем весь комплекс работ по обеспечению объектов системами
        видеонаблюдения
      </p>
      <List
